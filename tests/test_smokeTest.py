...
class TestSmokeTest():
  ...
  def test_smoketestv16(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Kevin Daniel")
    self.driver.find_element(By.NAME, "lname").send_keys("Morales Estrella")
    self.driver.find_element(By.NAME, "bizname").send_keys("Life Idiomas")
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("kmorales")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("1234567789")
